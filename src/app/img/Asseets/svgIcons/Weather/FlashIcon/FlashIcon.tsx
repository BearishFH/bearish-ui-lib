...
export const FlashIcon: React.FC<ISvg> = ({ color, className, iconType = 'linear', w = 24 }) => {
  const renderIcon = () => {
    switch (iconType) {
      case 'linear':
      case 'outline':
      ...
      case 'broken':
        return (
          <>
            <path
              d="M22.0004 12.6302C22.6604 11.8802 22.1304 10.7102 21.1304 10.7102H18.0404V3.5102C18.0404 2.4502 16.7204 1.9502 16.0204 2.7502L8.45043 11.3502C7.79043 12.1002 8.32043 13.2702 9.32043 13.2702H12.4104V20.4702C12.4104 21.5302 13.7304 22.0302 14.4304 21.2302L19.0604 15.9702"
              stroke="currentColor"
              strokeWidth="1.5"
              strokeMiterlimit="10"
              strokeLinecap="round"
